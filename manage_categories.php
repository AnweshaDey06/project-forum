            ...
            <tbody>
                <?php foreach ($categories as $category): ?>
                    <tr>
                        ...
                        <td>
                            <div class="ms-2">
                            <button class="btn btn-sm btn-primary mt-1" style="width:10vh;" data-toggle="modal" data-target="#editModal" onclick="populateEditForm(<?php echo $category['c_id']; ?>, '<?php echo addslashes(htmlspecialchars($category['c_name'])); ?>', '<?php echo addslashes(htmlspecialchars($category['c_description'])); ?>')">Edit</button>
                                <button class="btn btn-sm btn-danger mt-1" style="width:10vh;" data-toggle="modal" data-target="#deleteModal" onclick="populateDeleteForm(<?php echo $category['c_id']; ?>)">Delete</button>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
