    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" id="categoryDropdown" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item text-primary" id="viewMoreBtn" data-offset="5" href="#"><i>View More...</i></a> 
        ...
        <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) : ?>
            <form class="form-inline my-2 my-lg-0">
                <p class="text-light my-0 ml-1 mr-auto">
                    <a href="profile.php?user_id=<?php echo $_SESSION['u_id']; ?>" class="nav-link text-white mr-auto"> WELCOME <?php echo $_SESSION['u_email']; ?></a>
                </p>
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    if (!document.getElementById('viewLessBtn')) {
                        ...
                        viewLessBtn.className = 'dropdown-item text-primary';
